...
/**
 *@Note: Use switch & case with MACROs
 */
...
/**
 *@brief : Function that takes a struct of Pin configurations and sets them.
 *@param : Struct that contains Port Number, Pin Number, and Configuration Type (Input PullUp, Input PullDown, Output).
 *@return: Error State.                                                                      
 */
DIO_enumErrorStatus_t DIO_enumSetConfigWithoutLogic(DIO_strDioCfgWithoutLogic * Add_strDioCfg, u8 Loc_u8StructSize)
{
	/*Create an Error Status Variable*/
	DIO_enumErrorStatus_t RET_enumErrorStatus=DIO_enumNok;
	/*Check if Address is Equal to NULL*/
